...
class EmergencyListenerPage extends StatefulWidget {
  ...
  const EmergencyListenerPage({super.key, this.patientUserId});

  @override
  State<EmergencyListenerPage> createState() => _EmergencyListenerPageState();
}

class _EmergencyListenerPageState extends State<EmergencyListenerPage> {
